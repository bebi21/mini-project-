    ...
    <>
      <div>
        <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
          ...
          <div className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 text-sm  bg-blue-300 hover:bg-blue-500  text-white  hover:text-black  font-bold  rounded-xl transition duration-200">
            <Link to="/cart">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <a
            className="hidden lg:inline-block py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-black-500 font-bold rounded-xl transition duration-200"
            href="#"
          >
            {cart.length}
          </a>
